...
//        ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("vm://localhost");
        ActiveMQConnectionFactory connectionFactory =
                new ActiveMQConnectionFactory(Broker.URI);
        connectionFactory.setUserName(Broker.USERNAME);
        connectionFactory.setPassword(Broker.PASSWORD);
        // Create a Connection
        ...
        Destination destination = session.createTopic("input");
